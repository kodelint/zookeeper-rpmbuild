...
%define _conf_dir    %{_prefix}/zookeeper/conf
%define _log_dir     %{_prefix}/zookeeper/logs
%define _data_dir    %{_prefix}/zookeeper/data
...
# Ideally we should only be downloading stable releases but we wanted
# the ability to download and build RPMs from any Zookeeper Tarball version.
# Please Note: please check the "http://archive.apache.org/dist/zookeeper/stable/" for the stable release.
Source0: http://archive.apache.org/dist/zookeeper/zookeeper-%{version}/zookeeper-%{version}.tar.gz
